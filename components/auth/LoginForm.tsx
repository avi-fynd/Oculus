  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', maxWidth: '400px', margin: '0 auto' }}>
      ...
      <form onSubmit={handleSubmit} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          ...
          <div style={{ textAlign: 'right' }}>
            <a href="#" style={{ fontFamily: 'var(--font-body)', fontSize: '14px', color: 'var(--brand-secondary)', textDecoration: 'none' }}>
              Forgot password?
            </a>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <span style={{ fontFamily: 'var(--font-body)', fontSize: '13px', color: 'var(--text-muted)' }}>or continue with</span>
          <div style={{ flex: 1, height: '1px', background: 'var(--bg-border)' }} />
        </div>
      ...
      <p style={{ marginTop: '28px', fontFamily: 'var(--font-body)', fontSize: '14px', color: 'var(--text-secondary)' }}>
        ...
        <Link href="/signup" style={{ color: 'var(--brand-secondary)', textDecoration: 'none', fontWeight: 500 }}>
          Sign up →
        </Link>
      </p>
    </div>
